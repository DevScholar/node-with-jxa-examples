...
// We MUST hold onto the returned delegate ref at module scope:
// NSApplication.delegate is a weak reference, so if Node-side GC collects
// this proxy the delegate would be freed and the app would lose its
// termination policy.
...
const _delegate = $.NwjxaQuitOnLastClose.alloc.init;
